...
import connectfour.gui.ConnectFourGUI;
...
public class ConnectFourBoard {
    ...
    /**
     * Get the last row where a piece was placed.
     *
     * @return ROWS
     */
    ...
    /**
     * Get the last column where a piece was placed.
     *
     * @return COLS
     */
    ...
    public void makeMove(int col) {
        ...
        for (int r=ROWS-1; r>= 0; r--) {
            if (isValidMove(col) && getContents(r,col) == Player.NONE) {
