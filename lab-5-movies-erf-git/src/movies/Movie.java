...
public final class Movie implements Comparable<Movie> {
    ...
    public boolean equals(Object other) {
        ...
        // Movies are equal if they have the same title and were made in the same year
        boolean result = false;
        if (other instanceof Movie) {
            // Type casting the other object
            Movie otherMovie = (Movie) other;
            result = this.getTitle().equals(otherMovie.getTitle()) &&
    ...
    public int hashCode() {
        ...
        // Hash code -> adds the hash code of the title to the year
        return this.getTitle().hashCode() + this.getYear();
    }
