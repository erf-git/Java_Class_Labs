...
public class MovieComparatorRuntime implements Comparator<Movie> {
    ...
    public int compare(Movie m1, Movie m2) {
        ...
        // A movie with a longer length comes before a movie with a less length.
        // If two movies have the same runtime length, they should be ordered alphabetically by title
