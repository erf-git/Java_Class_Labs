...
public class Woolie extends Thread {
    ...
    private final static int CHANCE_TO_FALL = 10;
     ...
     * Starts with totalCrossingTime and decreases */
    ...
    public void run()  {
        ...
        this.preserver = Optional.ofNullable(kraken.getPreserver(this));
        ...
        while (this.crossingTimeRemaining > 0) {
            ...
            if (this.obstacleCourse.isRunning()) {
                ...
                // Course is not running (woolie fell)
